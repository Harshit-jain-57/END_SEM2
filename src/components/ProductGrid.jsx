    ...
    const products = [
        {
            ...
            description: "Hand-woven pure silk saree with intricate traditional designs",
            price: 15999,
            originalPrice: 19999,
            image: saree1,
            hoverImage: saree1h,
        ...
        },
        {
            ...
            description: "Classic Banarasi silk with rich zari work and timeless appeal",
            price: 25999,
            originalPrice: 29999,
            image: saree2,
            hoverImage: saree2h,
    ...
    return (
        <section className="products-section">
            <div className="container">
                ...
                <p className="section-description">Discover our exquisite range of handcrafted sarees</p>
